  ...
  return (
    <div className="min-h-screen" style={{ background: "#f8f6f0" }}>
      ...
      <footer className="border-t border-gray-200 py-6 text-center">
        <p className="text-xs text-gray-400">⚡ <strong className="text-gray-600">ElektriKamus</strong> — Kamus Visual Instalasi Listrik Rumah</p>
